...
angular.module("dashboard/positive-negative-feedback/comments-modal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("dashboard/positive-negative-feedback/comments-modal.tpl.html",
    ...
    "        </table>\n" +
    "        <div class=\"content\">\n" +
    "          <div ng-hide=\"show_no_data_message\">\n" +
    ...
    "          </div>\n" +
    "          </div>\n" +
    "          <div ng-show=\"show_no_data_message\" class=\"data-msg\"><span>No Comments Found</span></div>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "  </div>\n" +
...
angular.module("login/login.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("login/login.tpl.html",
    ...
    "  <div id=\"header\">\n" +
    "    <div class=\"logo\">\n" +
    "      <a href=\"http:\\\\mcdonalds.com.pk\" target=\"_blank\"><img src=\"assets/images/logo.png\" width=\"116\" height=\"112\" alt=\"McDonald &reg;\"></a>\n" +
    "    </div>\n" +
...
angular.module("manage-users/edit-user-modal.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("manage-users/edit-user-modal.tpl.html",
    ...
    "              <input type=\"text\" id=\"first_name\" class=\"form-control\" ng-model=\"user.first_name\" name=\"first_name\" required=t rue maxlength=\"12\">\n" +
    "              <div ng-show=\"UserForm.first_name.$error.required && (!UserForm.first_name.$pristine || submitted == true)\" class=\"form-error-message pull-left\">First Name is required.\n" +
    "              </div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"form-group\">\n" +
    ...
    "            <div class=\"col-sm-10 col-md-9\">\n" +
    "              <input type=\"text\" id=\"last_name\" class=\"form-control\" ng-model=\"user.last_name\" name=\"last_name\" required=\"true\" maxlength=\"12\">\n" +
    "              <div ng-show=\"UserForm.last_name.$error.required && (!UserForm.last_name.$pristine || submitted == true)\" class=\"form-error-message pull-left\">Last Name is required.\n" +
    "              </div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    ...
    "            <div class=\"col-sm-10 col-md-9\">\n" +
    "              <input type=\"text\" id=\"username\" class=\"form-control\" ng-model=\"user.username\" name=\"username\" required=t rue autocomplete=\"off\">\n" +
    "              <div ng-show=\"UserForm.username.$error.required && (!UserForm.username.$pristine || submitted == true)\" class=\"form-error-message pull-left\">User Name is required.\n" +
    "              </div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "        </div>\n" +
    ...
    "            <div class=\"col-sm-10 col-md-9\">\n" +
    "              <input type=\"password\" id=\"password\" class=\"form-control\" ng-model=\"user.password\" name=\"password\" autocomplete=\"off\" ng-required=\"!edit_form\">\n" +
    "              <div ng-show=\"UserForm.password.$error.required && (!UserForm.password.$pristine || submitted == true)\" class=\"form-error-message pull-left\">Password is required.\n" +
    "              </div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "          <div class=\"form-group\">\n" +
    ...
    "            <div class=\"col-sm-10 col-md-9\">\n" +
    "              <input type=\"tel\" id=\"phone_no\" class=\"form-control\" ng-model=\"user.phone_no\" name=\"phone_no\" required=t rue ng-pattern=\"/^[0-9]+$/\" maxlength=\"15\">\n" +
    "              <div ng-show=\"UserForm.phone_no.$error.required && (!UserForm.phone_no.$pristine || submitted == true)\" class=\"form-error-message pull-left\">Phone no is required.\n" +
    "              </div>\n" +
    "              <div ng-show=\"UserForm.phone_no.$error.pattern && (!UserForm.phone_no.$pristine || submitted == true)\" class=\"form-error-message pull-left\">Wrong number pattern.</div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "        </div>\n" +
    "        <div class=\"col-xs-12\">\n" +
    ...
    "            <div class=\"col-sm-10 col-md-9\">\n" +
    "              <select id=\"branch\" class=\"barcode\" custom-form ng-options=\"branch.id as branch.name for branch in branches track by branch.id\" ng-model=\"user.branch_id\" name=\"branch\" required>\n" +
    "                <option class=\"hideme\" value=\"\">Please Select a Branch</option>\n" +
    "              </select>\n" +
    "              <div ng-show=\"UserForm.branch.$error.required && (!UserForm.branch.$pristine || submitted == true)\" class=\"form-error-message pull-left\">Branch is required.\n" +
    "              </div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    ...
    "            <div class=\"col-sm-10 col-md-9\">\n" +
    "              <select id=\"region\" class=\"barcode\" custom-form ng-options=\"region.id as region.name for region in regions track by region.id\" ng-model=\"user.region_id\" name=\"region\" required=\"true\" ng-selected=\"user.region_id\">\n" +
    "                <option class=\"hideme\" value=\"\">Please Select a Region</option>\n" +
    "              </select>\n" +
    "              <div ng-show=\"UserForm.region.$error.required && (!UserForm.region.$pristine || submitted == true)\" class=\"form-error-message pull-left\">Region is required.\n" +
    "              </div>\n" +
    "            </div>\n" +
    "          </div>\n" +
    "        </div>\n" +
