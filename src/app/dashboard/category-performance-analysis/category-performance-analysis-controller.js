(function() {
  ...
  .controller('CategoryPerformanceAnalysisCtrl', function CategoryPerformanceAnalysisCtrl($scope, $rootScope, feedbackService, CategoryPerformanceApi, flashService, $uibModal) {
